...
def args_parser():
    ...
    # federated arguments
    parser.add_argument('--epochs', type=int, default=50, help="rounds of training")  # Reduced from 2000
    parser.add_argument('--num_users', type=int, default=50, help="number of users: K")  # Reduced from 100
    parser.add_argument('--frac', type=float, default=0.2, help="the fraction of clients: C")  # Increased from 0.1
    parser.add_argument('--local_ep', type=int, default=2, help="the number of local epochs: E")  # Reduced from 5
    parser.add_argument('--local_bs', type=int, default=32, help="local batch size: B")  # Reduced from 50
    parser.add_argument('--bs', type=int, default=64, help="test batch size")  # Reduced from 128
    ...
    parser.add_argument('--gpu', type=int, default=-1, help="GPU ID, -1 for CPU")  # FIXED: Only one --gpu entry, defaulting to CPU
    parser.add_argument('--stopping_rounds', type=int, default=10, help='rounds of early stopping')
    parser.add_argument('--verbose', action='store_true', help='verbose print')
    parser.add_argument('--seed', type=int, default=42, help='random seed (default: 42)')  # FIXED: Only one --seed entry with value 42
    ...
    parser.add_argument('--physical_time', type=float, default=900000, help='bound with physical time')  # FIXED: Set to 15 minutes
